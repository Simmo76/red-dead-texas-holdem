...
| Mini Characters — five rigged 3D NPCs (GLB, embedded sit/emote/die animations) + colormap for the web 3D scene | `Web/CinematicPoker.Web/wwwroot/models/characters/*.glb`, `Web/CinematicPoker.Web/wwwroot/models/characters/Textures/colormap.png` | [kenney.nl/assets/mini-characters](https://kenney.nl/assets/mini-characters) | Kenney Vleugels (kenney.nl) | [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/) |
