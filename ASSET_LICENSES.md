...
| Background music (60s loop) — track supplied privately by the repository owner for this project, re-encoded to OGG | `Web/CinematicPoker.Web/wwwroot/audio/saloon-music.ogg` | Supplied by repository owner (Google Drive) | Repository owner's licensed material | Used with the owner's permission; no third-party metadata present |
